      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <button
            ...
            className="md:hidden inline-flex items-center justify-center rounded-full border border-gray-200 bg-white/90 p-2 text-gray-700 shadow-sm hover:bg-orange-50 hover:border-orange-200 transition-colors"
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-x-0 top-16 z-40 px-4 pb-4">
          <div className="rounded-3xl bg-white/95 backdrop-blur border border-gray-100 shadow-2xl px-4 py-4 space-y-2">
            <button
              onClick={() => scrollToSection('home')}
              className="flex w-full items-center justify-between rounded-2xl px-3 py-3 text-base font-medium text-gray-900 hover:bg-orange-50"
            >
            ...
            <button
              onClick={() => scrollToSection('contact')}
              className="block w-full text-left py-2 bg-orange-500 text-white rounded-full hover:bg-orange-600 text-center"
            >
              Contact Us
            </button>
          </div>
